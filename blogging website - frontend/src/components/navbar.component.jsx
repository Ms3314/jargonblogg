...
const Navbar = () => {
    ...
    return (
        ...
        <nav className="navbar">
            <Link to="/home" className='flex-none w-10 mb-[-20px]' >
            <img src={logo} alt="a logo" /> 
            <button className='hide bg-red'>cool</button>
            </Link>
        {/* {open && <div className='py-4 px-[5vh] absolute w-full md:show left-0 top-full mt-0.5 border-b border-grey md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto' >
                <input
                    type="text"
                    placeholder='Search'
